...
#include <ArduinoJson.h>//DANIEL CODE
...
class WiFiManager
{
  public:
    ...
    //DANIEL CODE
        void setPersonalizedDataScript(String script);
        void setPersonalizedDataStyle(String style);        
        void setPersonalizedHTML(String html);
        String getParamAsJSON(void);   

        void setPersonalizedDataFavicon(String favicon);
        void setPersonalizedDataIcon(String icon);     
    //______________

  private:
    //DANIEL CODE
        bool _personalizedDataStyle = false;
        bool _personalizedDataScript = false;     
        bool _personalizedDataFavicon = false;
        bool _personalizedDataIcon = false;
        bool _personalizedHTML = false;          

        String COSTUMIZED_HTTP_STYLE ;
        String COSTUMIZED_HTTP_SCRIPT;
        String COSTUMIZED_HTTP_FAVICON;
        String COSTUMIZED_HTTP_ICON;
        String COSTUMIZED_HTTP_HTML;

        String getContentType(String filename);
        bool sendToClient(String fileName);

        String paramAsJSON;
        void saveParamAsJSON(void);       
    //______________
