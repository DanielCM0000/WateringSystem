function functionToBeCalledAfterCustomHtmlRendering() {
    setupIPandFORM();    
}
//________________________________BEGIN IP AND FORM EVENT__________________________________
function setupIPandFORM() { //https://www.w3schools.com/jsref/event_onsubmit.asp       
    var_ip = $('#ip').ipInput();
    var_ip.setIp('192.168.1.1');
...
//________________________________________FORM EVENT______________________________________
function runFormEvent(var_ip){ //https://www.w3schools.com/jsref/event_onsubmit.asp     
    $('#_ip').val(var_ip.getIp());
}
//_______________________________________PLUGIN_IP________________________________________
